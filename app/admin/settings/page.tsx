      ...
      <div className="w-full max-w-md">
        <div className="flex items-center gap-2 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Manage your admin profile</p>
          </div>
        </div>

        <form onSubmit={handleSave} className="bg-white rounded-2xl border border-[#e8d5d5] shadow-sm p-6 space-y-4">
