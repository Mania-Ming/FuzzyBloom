          ...
          <div className="py-2">
            ...
            <div className="flex gap-3 mb-3">
              <button onClick={addToWishlist} disabled={!isAvailable}
                className={`w-12 h-12 flex items-center justify-center border-2 rounded-full transition ${isAvailable ? "border-gray-200 hover:border-pink-400 hover:text-pink-500" : "border-gray-100 text-gray-300 cursor-not-allowed"}`}>♡</button>
